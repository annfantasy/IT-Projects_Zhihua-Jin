...
above epsilon = math.exp(-0.01 * t) | 0.5 | 0.01 | 20
...
# Above: epsilon = 0.99**(t-1), alpha=math.e**(-0.001 * t), tolerance=0.01，test=20'

# 序号 | Q-Learning 衰减函数 | Alpha | Tolerance | n_test | 安全率 | 可靠率
# --- | ------------------ | ----- | --------- | ------ | ----- | -----
# 1    | epsilon = math.exp(-0.01 * t) | 0.5 | 0.1 | 20 | F | B
# 2   | epsilon = math.cos(t * 0.1) | 0.5 | 0.1 | 20 | A | D
# 3   | epsilon = math.cos(t * 0.0015) | 0.5 | 0.1 | 20 | A+ | A
# 4   | epsilon = math.cos(t * 0.0015) | math.e**(-0.001 * t) | 0.1 | 20 | A+ | A+
